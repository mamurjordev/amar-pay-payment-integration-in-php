...
<html><title>Secured Payment Gateway || Test by Mamurjor IT</title>
<head>
...
?>  
  <body>
                    ...
                    <tr><td>Customer Name: *</td><td><input type="text" name="cus_name" value="hadi vai"></td></tr>
                    <tr><td>Customer Email Address: *</td><td><input type="text" name="cus_email" value="mamurjor@mamurjor.com"></td></tr>
                    <tr><td>Customer Address Line 1: </td><td><input type="text" name="cus_add1" value="Mirpur#10"></td></tr>
                    <tr><td>Customer Address Line 2: </td><td><input type="text" name="cus_add2" value="Mirpur#10"></td></tr>
                    ...
                    <tr><td>Customer Phone: </td><td><input type="text" name="cus_phone" value="01746686868"></td></tr>
                    <tr><td>Customer Fax: </td><td><input type="text" name="cus_fax" value="01746686868"></td></tr>
                    ...
                    <tr><td>Product Description: </td><td><input type="text" name="desc" value="বুফে খাবো টাকা দেন, 01746686868"></td></tr>
                    <input type="hidden" name="success_url" value="http://www.hadijaman.com/payeasy/success.php">
                    <input type="hidden" name="fail_url" value = "http://www.hadijaman.com/payeasy/fail.php">
                    <input type="hidden" name="cancel_url" value = "http://www.hadijaman.com/payeasy/fail.php">
